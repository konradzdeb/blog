...
R wasn't designed to replace ETL^[Export Transform Load] processes; nevertheless, as every other well-developed programming language R offers a set of robust tools for accomplising file manipulation, analysis and creation. In particular, R package ecosystem offers a layer that provides a clean interface for accomplishing traditional  
