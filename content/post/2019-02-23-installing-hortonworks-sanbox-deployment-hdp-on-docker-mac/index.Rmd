...
The [hortonworks/sandbox-hdp-standalone](https://hub.docker.com/r/hortonworks/sandbox-hdp-standalone) is available via Docker website and can be installed with the following command:

```{sh docker_image, eval=FALSE, echo=TRUE}
