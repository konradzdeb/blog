...
What is most worrisome is not the fact that data science teams frequently deliver an average quality code but the fact that this is very problem is often ignored by business. The challenge has complex roots and can be traced to a few wider key characteristics associated with the place of data science team in business. Broadly, those will be related to the following aspects:
...
In a software-oriented business (i.e. think of a software house that makes living out of churning mobile phone apps) we would pick a number of characteristics that constitute good coding environment. The excellent article defining wider business characteristics was published by [Joel Spolsky](https://www.joelonsoftware.com) and focuses on characteristics we would like to see in a well-organised software development business. Leaving on side wider office dynamic, from a coding perspective in a good workflow we would anticipate to find the following elements properly defined
