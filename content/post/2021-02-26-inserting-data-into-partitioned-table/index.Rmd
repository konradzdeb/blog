...
DBI::dbSendQuery(sc, "DROP DATABASE IF EXISTS blog")
unlink(file.path(getwd(), "spark-warehouse/*"), recursive = TRUE, force = TRUE)
```
...
```{r iterate_and_insert, eval=FALSE}
suppressPackageStartupMessages(library(DBI))
...
```{r bulk_insert, eval=TRUE, message=FALSE}
DBI::dbSendQuery(sc, "
